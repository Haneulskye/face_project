...
android {
    namespace = "com.faceproject.android"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.faceproject.android"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"

        // Emulator -> host loopback. Change for a physical device / real server.
    ...
    buildTypes {
        release {
            ...
            buildConfigField("String", "API_BASE_URL", "\"https://postpositively-noninhibitory-anita.ngrok-free.dev/\"")
        }
    }
